<section class="w-full h-full">
    <form wire:submit.prevent='submit' class="container py-5 lg:w-3/4 space-y-7 lg:px-28">
        ...
        <div class="flex flex-col w-full gap-3 lg:flex-row lg:items-center">
            <div class="flex-1">
                <label for="name" class="text-base lg:text-lg lg:font-medium">Accessory Name</label>
            ...
            <div class="flex-1">
                <label for="manufacturer" class="text-base lg:text-lg lg:font-medium">Accessory Manufacturer</label>
        ...
        <div class="flex flex-col w-full gap-3 lg:flex-row lg:items-center">
            <div class="flex-1">
                <label for="price" class="text-base lg:text-lg lg:font-medium">Accessory Price</label>
            ...
            <div class="flex-1">
                <label for="type" class="text-base lg:text-lg lg:font-medium">Accessory Type</label>
