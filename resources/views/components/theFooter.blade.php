<footer
    class="p-4 mt-5 bg-white rounded-lg shadow md:px-6 md:py-8 {{ Route::is('garage.show') || Route::is('admin-dashboard') ? 'absolute left-0 bottom-0 w-full' : '' }}">
    <div class="sm:flex sm:items-center sm:justify-between">
        <a href="/" class="flex items-center mb-4 sm:mb-0">
            <img src="{{ asset('assets/svg/car_logo.svg') }}" class="h-8 mr-3 " alt="MCars Logo">
    ...
    <span class="block text-sm text-gray-500 sm:text-center ">&copy; 2022 <a href="/" class="hover:underline">M
